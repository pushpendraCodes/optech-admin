...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <button className="absolute inset-0 bg-[#06060e]/75 backdrop-blur-sm" aria-label="Close" onClick={onClose} />
      <div className="card relative z-10 max-h-[90vh] w-full max-w-xl overflow-y-auto p-6 shadow-[0_24px_80px_rgba(139,44,255,0.18)]">
